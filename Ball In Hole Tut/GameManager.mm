...
-(void)runSceneWithID:(SceneTypes)sceneID {
    ...
    switch (sceneID) {
        ...
        case kIntroScene:
            ...
            break;
        case kLevelCompletedScene:
            //sceneToRun = [LevelCompleteScene node];
            break;
        case kLevel1MenuScene: 
            sceneToRun = [Level1Scene2 node];
            break;
        case kLevel2MenuScene:
            //sceneToRun = [GameScene2 node];
            break;
        case kLevel3MenuScene:
            //sceneToRun = [PuzzleLayer scene];
            break;
        case kLevel1Scene1:
            sceneToRun = [Level1Scene1 node];
            break;
        case kLevel1Scene2:
            sceneToRun = [Level1Scene2 node];
            break;
        case kLevel1Scene3:
            sceneToRun = [Level1Scene3 node];
            break;
        case kLevel2Scene1:
            sceneToRun = [Level2Scene1 node];
            break;
        case kLevel2Scene2:
            sceneToRun = [Level2Scene2 node];
            break;
        case kLevel2Scene3:
            sceneToRun = [Level2Scene3 node];
            break;
        case kLevel3Scene1:
            sceneToRun = [Level3Scene1 node];
            break;
...
- (NSString*)formatSceneTypeToString:(SceneTypes)sceneID {
    ...
    switch(sceneID) {
        ...
        case kIntroScene:
            ...
            break;
        case kLevelCompletedScene:
            result = @"kLevelCompletedScene";
            break;
        case kLevel1Scene1:
            result = @"kLevel1MenuScene";
            break;
        case kLevel1Scene2:
            result = @"kLevel1MenuScene";
            break;
